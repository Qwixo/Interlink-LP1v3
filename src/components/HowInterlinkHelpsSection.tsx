...
const HowInterlinkHelpsSection = () => {
  ...
  const tabs = [
    ...
    {
      icon: <FaPassport className="text-4xl text-[#064088] mb-4" />,
        ...
        <div className="flex flex-wrap justify-center mb-8">
          {tabs.map((tab, index) => (
            <button
              ...
              className={`px-4 py-3 mx-2 mb-2 rounded-lg transition-colors ${
                activeTab === index 
                  ? 'bg-[#064088] text-white font-medium' 
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
            ...
            <div className="md:w-3/4">
              <div className="flex items-center mb-4">
                <span className="text-[#064088] mr-2">✅</span>
                <h3 className="text-2xl font-bold text-[#dc5d33]">{tabs[activeTab].title}</h3>
              </div>
